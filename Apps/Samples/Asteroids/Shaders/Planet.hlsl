...
FILE: MethaneKit/Apps/Samples/Asteroids/Shaders/Planet.hlsl
Shaders for planet rendering with spheric texture and Phong lighting.
...
float4 PlanetPS(PSInput input) : SV_TARGET
{
