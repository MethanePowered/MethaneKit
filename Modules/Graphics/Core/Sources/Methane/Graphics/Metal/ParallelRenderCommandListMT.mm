...
Ptr<ParallelRenderCommandList> ParallelRenderCommandList::Create(ICommandQueue& command_queue, IRenderPass& render_pass)
{
    META_FUNCTION_TASK();
...
void ParallelRenderCommandListMT::ResetWithState(IRenderState& render_state, DebugGroup* p_debug_group)
{
    META_FUNCTION_TASK();
