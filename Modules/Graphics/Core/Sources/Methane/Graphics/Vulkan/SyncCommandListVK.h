...
FILE: Methane/Graphics/Metal/SyncCommandListVK.h
Vulkan implementation of the synchronization command list interface.
...
class SyncCommandListVK final
    : public CommandListBase
    , public SyncCommandList
{
public:
    explicit SyncCommandListVK(CommandQueueBase& command_queue);
