...
public:
    ...
    void SetResourceBarriers(const IResource::Barriers&) override { META_FUNCTION_NOT_IMPLEMENTED_DESCR("Can not set resource barriers on parallel render command list."); }
