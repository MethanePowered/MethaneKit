...
FILE: Methane/Graphics/ITexture.h
...
struct TextureSettings
{
    ...
    ResourceUsage         usage_mask     = ResourceUsage::None;
    ...
    [[nodiscard]] static TextureSettings DepthStencilBuffer(const Dimensions& dimensions, PixelFormat pixel_format, ResourceUsage usage_mask = ResourceUsage::RenderTarget);
};
