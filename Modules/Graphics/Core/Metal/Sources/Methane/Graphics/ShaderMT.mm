...
#include <Methane/Graphics/ShaderMT.hh>
#include <Methane/Graphics/ProgramMT.hh>
#include <Methane/Graphics/ProgramLibraryMT.hh>
#include <Methane/Graphics/ProgramBindingsMT.hh>
...
{
    META_FUNCTION_TASK();
    return dynamic_cast<const IContextMT&>(GetContext());
}
