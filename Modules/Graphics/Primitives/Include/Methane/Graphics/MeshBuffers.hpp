...
public:
                                                                             ...
                                                                             { 0, mesh_data.GetIndexCount()  }, true ) })
    {
        ...
        vertex_buffer.InitVertexBuffer(render_cmd_queue.GetContext(),
        ...
        m_index_buffer.InitIndexBuffer(render_cmd_queue.GetContext(), static_cast<Data::Size>(mesh_data.GetIndexDataSize()), GetIndexFormat(mesh_data.GetIndex(0)));
    ...
    [[nodiscard]] const Rhi::IContext& GetContext() const noexcept
    {
        return m_context;
    }
    ...
    void Draw(Rhi::RenderCommandList& cmd_list, const std::vector<Rhi::ProgramBindings>& instance_program_bindings,
    ...
    void Draw(Rhi::RenderCommandList& cmd_list,
    ...
    [[nodiscard]]
    const Rhi::SubResources& GetFinalPassUniformsSubresources() const
    { return m_final_pass_instance_uniforms_subresources; }

    [[nodiscard]]
    const Rhi::BufferSet& GetVertexBuffers()
    {
        return m_vertex_buffer_set;
    }

    [[nodiscard]]
    const Rhi::Buffer& GetIndexBuffer()
    {
