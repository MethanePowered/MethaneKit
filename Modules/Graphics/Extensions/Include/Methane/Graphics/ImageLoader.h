...
public:
    ...
    [[nodiscard]] Ptr<Texture> LoadImageToTexture2D(Context& context, const std::string& image_path, Options options = Options::None, const std::string& texture_name = "") const;
    [[nodiscard]] Ptr<Texture> LoadImagesToTextureCube(Context& context, const CubeFaceResources& image_paths, Options options = Options::None, const std::string& texture_name = "") const;
