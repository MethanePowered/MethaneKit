...
{
public:
    Buffer(const Base::Context& context, const Settings& settings, ExtraViewArgs... view_args)
...
using VertexBuffer   = Buffer<D3D12_VERTEX_BUFFER_VIEW, Data::Size>;
using IndexBuffer    = Buffer<D3D12_INDEX_BUFFER_VIEW, PixelFormat>;
