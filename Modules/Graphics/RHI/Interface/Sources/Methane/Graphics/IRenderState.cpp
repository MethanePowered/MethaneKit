...
FILE: Methane/Graphics/IRenderState.cpp
...
template<>
struct fmt::formatter<Methane::Graphics::RenderTargetSettings>
{
    template<typename FormatContext>
    [[nodiscard]] auto format(const Methane::Graphics::RenderTargetSettings& rt, FormatContext& ctx) { return format_to(ctx.out(), "{}", static_cast<std::string>(rt)); }
