...
Ptr<Rhi::IProgramBindings> ProgramBindings::CreateCopy(
    const ResourceViewsByArgument& replace_resource_views_by_argument, const Opt<Data::Index>& frame_index)
{
    META_FUNCTION_TASK();
...
void ProgramBindings::CompleteInitialization(const ArgumentsRange& arg_range)
{
    META_FUNCTION_TASK();
...
// function void(const ArgumentBinding&)
                                  ...
                                  [&mtl_cmd_encoder, &program](const ArgumentBinding& argument_binding)
                                      {
                                          ...
                                          switch (settings.resource_type) {
                                              case Rhi::ResourceType::Buffer:
                                                  SetRenderResourcesForAll(settings.argument.GetShaderType(), program,
                                                                           mtl_cmd_encoder,
