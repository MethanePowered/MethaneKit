...
public:
    ...
    META_PIMPL_DEFAULT_CONSTRUCT_METHODS_DECLARE(RenderTargetTexture);

    RenderTargetTexture(const Ptr<ITexture>& interface_ptr);
    RenderTargetTexture(ITexture& interface_ref);
